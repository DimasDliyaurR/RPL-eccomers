<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
      ...
      <li class="menu-item {{ ($tittle === "Lihat Produk" || 
      $tittle === "Tambah Produk" || $tittle === "Tambah Stok") ? 'active open' : '' }}">
      ...
      <li class="menu-item {{ ($tittle === "Order Masuk" || 
            $tittle === "Order Terkirim") ? 'active open' : '' }}">
        <a href="javascript:void(0);" class="menu-link menu-toggle">

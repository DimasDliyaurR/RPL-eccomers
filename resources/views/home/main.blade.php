...
<body>
  ...
  <nav class="sticky top-0 z-50 bg-white drop-shadow">
    <div class="container bg-transparent flex justify-between items-center py-4 px-8">
      ...
      <div class="flex items-end">
        ...
        <p class="font-semibold text-primary">Furniture</p>
      </div>
      ...
      <div class="flex gap-8">
        <div class="dropdown flex items-center" id="dropdown">
          ...
          <div class="list absolute mt-[8.3rem] shadow-md shadow-slate-600 z-50 flex flex-col bg-white pt-3 pb-3 pl-2 pr-4 w-[10rem] rounded-xl transition ease-in-out" id="lists">
            <a href="" class="text-sm hover:bg-secondary transition ease-in-out delay-75 p-1 rounded-md">Kentot</a>
            <a href="" class="text-sm hover:bg-secondary transition ease-in-out delay-75 p-1 rounded-md">Memek</a>
            <a href="" class="text-sm hover:bg-secondary transition ease-in-out delay-75 p-1 rounded-md">Kontol</a>
          </div>
        </div>
      ...
      <div class="cart-acc flex gap-4 items-center">
        ...
        <div class="box-acc border-solid border-black border-x-2 border-y-2 p-[4px] rounded-full flex items-center justify-center cursor-pointer hover:fill-primary hover:border-primary" id="box-acc">
          ...
          <div class="acc absolute mt-[8.3rem] shadow-md shadow-slate-600 z-50 flex flex-col bg-white pt-3 pb-3 pl-2 pr-4 w-[10rem] right-1 rounded-xl transition ease-in-out" id="acc">
            <a href="" class="text-sm hover:bg-secondary transition ease-in-out delay-75 p-1 rounded-md">Login</a>
            <a href="" class="text-sm hover:bg-secondary transition ease-in-out delay-75 p-1 rounded-md">Register</a>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="desc-box px-2">
        ...
        <div class="rate-cart flex justify-between items-center mt-2">
          ...
          <div class="button-cart">
            <a href="#" class="text-[0.50rem] font-normal border border-secondary px-2 py-[0.15rem] rounded-full">+ Keranjang</a>
          </div>
  ...
  <div class="pagination container flex justify-center items-center gap-3">
    <div class="arrow-left cursor-pointer"> < </div>

        ...
        <div class="container bg-transparent flex justify-between items-center py-4 px-8">
            ...
            <div class="flex gap-8">
                <div class="dropdown flex items-center" id="dropdown">
                    ...
                    <div class="list absolute mt-[8.3rem] shadow-md shadow-slate-600 z-50 flex flex-col bg-white pt-3 pb-3 pl-2 pr-4 w-[10rem] rounded-xl transition ease-in-out"
                        id="lists">
                        <a href=""
            ...
            <div class="cart-acc flex gap-4 items-center">
                ...
                <div class="box-acc border-solid border-black border-x-2 border-y-2 p-[4px] rounded-full flex items-center justify-center cursor-pointer hover:fill-primary hover:border-primary"
                    ...
                    <div class="acc absolute mt-[8.3rem] shadow-md shadow-slate-600 z-50 flex flex-col bg-white pt-3 pb-3 pl-2 pr-4 w-[10rem] right-1 rounded-xl transition ease-in-out"
                        id="acc">
                        @if (Route::has('login'))
                            @auth
                                <a href="#"

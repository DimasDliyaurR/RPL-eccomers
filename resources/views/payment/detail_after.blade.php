    ...
    <div class="detail-bayar w-1/3 shadow-xl py-10 px-10 rounded-xl box-border">
      ...
      <div class="metode mt-6 relative">
        ...
        <div class="relative mt-2">
          <select class="block appearance-none w-full bg-white border border-gray-300  px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline focus:ring-0 focus:border-gray-300">
            <option>BRI</option>
            <option>BCA</option>
          </select>
        ...
        <button type="submit" class="bg-primary w-full text-white py-3 mt-5 rounded-xl hover:bg-orange-600">Bayar Sekarang</button>
      </div>
    </div>
  </div>
</section>

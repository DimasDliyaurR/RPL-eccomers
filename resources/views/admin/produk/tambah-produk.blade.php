        ...
        <div class="card-body">
          <form action="tambah-produk/addNew" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
              ...
              @enderror
              <input type="text" name="nama_produk" class="form-control" id="basic-default-fullname" placeholder="Nama Produk" value="{{ old('nama_produk') }}" />
            </div>
            ...
            <div class="mb-3">
              ...
              <select name="id_kategori" class="form-select" id="exampleFormControlSelect1" aria-label="Default select example" style="width: 15%;">
                ...
                <option value="1" {{ old('id_kategori') == 1 ? 'selected' : '' }}>Meja</option>
                <option value="2" {{ old('id_kategori') == 2 ? 'selected' : '' }}>Sofa</option>
                <option value="3" {{ old('id_kategori') == 3 ? 'selected' : '' }}>Kursi</option>
                <option value="4" {{ old('id_kategori') == 4 ? 'selected' : '' }}>Lemari</option>
                <option value="5" {{ old('id_kategori') == 5 ? 'selected' : '' }}>Kasur</option>
                <option value="6" {{ old('id_kategori') == 6 ? 'selected' : '' }}>Rak</option>
              </select>
            </div>
            ...
            <div class="mb-3">
              ...
              <span class="text-danger">{{ $message }}</span>
              @enderror
              <input type="number" name="stok" class="form-control" id="basic-default-fullname" placeholder="Jumlah Stok" value="{{ old('stok') }}" />
            </div>
